...
def get_multi(db: Session,limit: int,offset: int,order_id: int | None = None,product_id: int | None = None,):
...
def create(db: Session, order_id: int, product_id: int, quantity: int, unit_price: float):
